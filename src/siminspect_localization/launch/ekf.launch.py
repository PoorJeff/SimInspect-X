...
def generate_launch_description():
    ...
    relay = Node(package='siminspect_localization', executable='odometry_frame_relay.py')
    ...
    return LaunchDescription([DeclareLaunchArgument('use_sim_time', default_value='true'), relay, ekf])
